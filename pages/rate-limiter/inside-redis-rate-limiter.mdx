...
만약 우리가 RedisLimiter 를 의존성 주입하지 않는다면 Spring Cloud Gateway 에서 기본으로 제공해주는 [request_rate_limiter.lua](https://github.com/spring-cloud/spring-cloud-gateway/blob/af09c72a9a/spring-cloud-gateway-server/src/main/resources/META-INF/scripts/request_rate_limiter.lua)가 선택되어 사용하게 됩니다.<br/>
